...
namespace u2048
{
    class Game
    {
        ...
        public void DrawGame(Graphics g)
        {
            ...
            DrawTextCenterX(g, "Qodirova Sarvara", fFontS2, new SolidBrush(Color.FromArgb(120, 110, 101)), 198, 552);
            DrawTextCenterX(g, "2025", fFontS2, new SolidBrush(Color.FromArgb(120, 110, 101)), 198, 566);
        }
        ...
        public void DrawAbout(Graphics g)
        {
            ...
            DrawTextCenterXWS(g, "Qodirova Sarvara", fFontS, new SolidBrush(Color.FromArgb(255, 10, 10, 10)), new SolidBrush(Color.White), 198, 250);
            DrawTextCenterXWS(g, "telecom ---", fFontS, new SolidBrush(Color.FromArgb(255, 10, 10, 10)), new SolidBrush(Color.White), 198, 290);
            DrawTextCenterXWS(g, "UBTUIT", fFontS, new SolidBrush(Color.FromArgb(255, 10, 10, 10)), new SolidBrush(Color.White), 198, 310);
            DrawTextCenterXWS(g, "telegram qodirova0206", fFontS, new SolidBrush(Color.FromArgb(255, 10, 10, 10)), new SolidBrush(Color.White), 198, 350);
            DrawTextCenterXWS(g, "2025", fFontS, new SolidBrush(Color.FromArgb(255, 10, 10, 10)), new SolidBrush(Color.White), 198, 370);
        }
